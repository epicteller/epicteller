...
CREATE TABLE IF NOT EXISTS `character_campaign_index`
(
    `id`           BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    UNIQUE KEY `unq_character_campaign` (`character_id`, `campaign_id`),
    UNIQUE KEY `unq_campaign_character` (`campaign_id`, `character_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `unq_url_token` (`url_token`),
    KEY `idx_room_id` (`room_id`, `is_removed`, `id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;

CREATE TABLE IF NOT EXISTS `room_running_combat`
(
    `id`        BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `room_id`   BIGINT(20) UNSIGNED NOT NULL,
    `combat_id` BIGINT(20) UNSIGNED NOT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `unq_room_id` (`room_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;